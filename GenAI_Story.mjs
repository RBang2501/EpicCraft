...
const baseinstruct = "Write a Chapters of story about The Masquerade of Masks . start the story with input . Chapter length 150 words only";
const baseinput = 'Beneath the glittering chandeliers and swirling waltzes, secrets danced behind gilded masks. Infiltrating the opulent ball, I donned a visage of my own, determined to expose the web of deceit and uncover the identity of the phantom lurking in the shadows.';
...
(async () => {
    ...
    console.log(`\n\n\n${title}\n${Twist4}`);
    const id4 = await Publish(title, Twist4,id3.data.hashId);
